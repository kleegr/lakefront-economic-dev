          ...
          {forgotMode ? (
            forgotSent ? (
              <div className="text-center py-6">
                ...
                <h3 className="font-display font-bold text-brand-forest text-lg mb-2">Reset Link Sent!</h3>
                <p className="text-sm font-body text-brand-muted">Check your email for a password reset link.</p>
                <button onClick={() => { setForgotMode(false); setForgotSent(false); }} className="text-sm font-body text-brand-sage hover:text-brand-forest mt-4">Back to Login</button>
              </div>
            ) : (
              <div className="space-y-4">
                <h3 className="font-display font-semibold text-brand-forest text-center">Reset Password</h3>
                <p className="text-xs font-body text-brand-muted text-center">Enter your email and we&apos;ll send you a link to set a new password.</p>
