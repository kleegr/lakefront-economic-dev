...
export default function ServicesPage() {
  ...
  return (
    <div>
      <MovingBanner page="services" title="Service Providers" badge="Community" subtitle="Trusted service providers serving Lakefront Estates." />
      <div className="bg-[#FAFAF7] py-16">
        <div className="max-container section-padding">
          <div className="flex gap-4 mb-8 items-center">
            <div className="relative flex-1"><Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-300" /><input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search providers..." className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl text-sm font-body focus:outline-none focus:border-[#C9B97A]" /></div>
            <Link href="/apply/provider" className="px-6 py-3 rounded-full text-sm font-body font-semibold text-white shrink-0" style={{ backgroundColor: '#C9B97A' }}>Apply as Provider</Link>
          </div>
