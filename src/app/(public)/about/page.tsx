        ...
        <div className="max-container section-padding">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <ScrollReveal delay={100}>
              <div className="bg-white rounded-xl border border-gray-100 p-8">
                <div className="flex items-center gap-3 mb-4"><TrendingUp className="w-7 h-7" style={{ color: '#C9B97A' }} /><h2 className="font-display text-2xl font-bold" style={{ color: '#2C3E2D' }}>Lakefront Economics &mdash; Our Approach</h2></div>
                <p className="text-gray-600 font-body leading-relaxed mb-4">&ldquo;Lakefront Economics&rdquo; is our philosophy of community-driven growth. We take a holistic approach to economic development:</p>
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg"><strong className="text-brand-forest block mb-1">Service Provider Network</strong><p className="text-sm text-gray-500">A curated network of trusted vendors serving the community &mdash; from landscaping to IT support to security services.</p></div>
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-8">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <Link href="/businesses" className="group p-5 bg-gray-50 rounded-xl hover:shadow-md transition-all">
                    ...
                    <p className="text-sm text-gray-500 font-body mb-2">A growing ecosystem of local businesses &mdash; from grocery to medical to dining. Be part of the Lakefront community.</p>
                  ...
                  <Link href="/services" className="group p-5 bg-gray-50 rounded-xl hover:shadow-md transition-all">
                    ...
                    <p className="text-sm text-gray-500 font-body mb-2">Trusted vendors serving the Lakefront community &mdash; landscaping, security, IT, cleaning, and specialized services.</p>
            ...
            <ScrollReveal delay={300}>
              <div className="bg-white rounded-xl border border-gray-100 p-8">
                ...
                <p className="text-gray-600 font-body leading-relaxed mb-4">Located in the heart of Okeechobee, Florida, Lakefront Estates offers easy access to major roads and a scenic lakefront setting. The development blends Florida&rsquo;s natural beauty with modern commercial infrastructure.</p>
                <p className="text-gray-600 font-body leading-relaxed">Okeechobee is one of Florida&rsquo;s fastest-growing communities, with increasing demand for housing, commercial services, and employment. Lakefront Estates is positioned to meet this demand while maintaining the small-town character that makes Okeechobee special.</p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={400}>
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-500 font-body max-w-lg mx-auto">Whether you&rsquo;re looking for a job, a commercial space, or want to offer your services &mdash; there&rsquo;s a place for you at Lakefront.</p>
