          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg p-4">
              ...
              <ol className="text-xs font-body text-blue-700 space-y-1 list-decimal list-inside">
                <li>Click &ldquo;Add Field&rdquo; button above</li>
                <li>Enter a <strong>Label</strong> (e.g. &ldquo;Experience Level&rdquo;)</li>
                <li>The <strong>DB Key</strong> auto-generates (e.g. &ldquo;experience_level&rdquo;)</li>
                <li>Set the <strong>Kleegr Key</strong> &mdash; this must match the field key in Kleegr Custom Object</li>
                ...
                <li>Save &mdash; the field immediately appears on the job form</li>
              </ol>
            </div>
            <div className="bg-white rounded-lg p-4">
              ...
              <ol className="text-xs font-body text-blue-700 space-y-1 list-decimal list-inside">
                <li>Go to Kleegr &rarr; Settings &rarr; Custom Objects &rarr; Job Openings</li>
                <li>Click &ldquo;Add Property&rdquo;</li>
            ...
            <div className="bg-white rounded-lg p-4">
              ...
              <ol className="text-xs font-body text-blue-700 space-y-1 list-decimal list-inside">
                ...
                <li><strong>Value</strong> = what&rsquo;s stored in database (e.g. &ldquo;full-time&rdquo;)</li>
                <li><strong>Kleegr Label</strong> = what&rsquo;s shown in Kleegr (e.g. &ldquo;Full-Time&rdquo;)</li>
                <li>Add the same option in Kleegr Custom Object dropdown</li>
                <li>Save &mdash; done!</li>
              </ol>
            </div>
          </div>
          <div className="bg-white rounded-lg p-4">
            ...
            <div className="grid grid-cols-3 gap-2 text-xs font-body text-gray-600">
              <div className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-green-400" /> Field added here &rarr; form shows it</div>
              <div className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-blue-400" /> Kleegr Key set &rarr; syncs to Kleegr</div>
              <div className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-amber-400" /> No Kleegr Key &rarr; portal only, no sync</div>
            </div>
          </div>
        </div>
      )}
